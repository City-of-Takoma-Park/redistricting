...
# -----------------------------
header_file_path <- "data/maryland_2020/mdgeo2020.pl"
part1_file_path  <- "data/maryland_2020/md000012020.pl"
part2_file_path  <- "data/maryland_2020/md000022020.pl"
part3_file_path  <- "data/maryland_2020/md000032020.pl"
...
# comine subset
subset_vars <- data.frame(name = c("P0010001",
                                   "P0010003",
                                   "P0010004",
                                   "P0010005",
                                   "P0010006",
...
md_data_sub <- combine %>%
  select(STUSAB, SUMLEV, GEOCOMP, GEOID, GEOCODE, REGION, DIVISION, STATE, COUNTY, PLACE, TRACT, BLKGRP, BLOCK, AREALAND, AREAWATR, subset_vars$name) %>%
